...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('movies/getFilters',[ApiController::class, 'getFilters']);
   ...
   // Route::get('movie/{show_id}',[ApiController::class, 'getMovie']);
    ...
    Route::post('/myList/delMyList',[ApiController::class,'delMyListById']);
    ...
    //Route::get('myList/getShows',[ApiController::class, 'completeCustomerList']);
    Route::post('/myList/getShows',[ApiController::class, 'completeCustomerList']);
